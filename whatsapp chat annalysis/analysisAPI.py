...
def fetch_stats(selected_user, df):
    ...
    num_media_messages = df[df['message'] == 'Share Media'].shape[0]
...
def create_wordcloud(selected_user, df):
    ...
    link_string = ' '.join([str(elem) for elem in links])
    stop_words = stop_words + link_string
